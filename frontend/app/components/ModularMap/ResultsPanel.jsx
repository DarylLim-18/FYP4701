  ...
  return (
    <div className="h-full rounded-xl border border-white/10 bg-white/5 p-4 overflow-y-auto">
      <div className="flex items-center justify-between mb-4">
        <div>
          <h3 className="text-lg font-semibold">Local Moran&apos;s I Results</h3>
          <p className="text-sm text-gray-400">Spatial autocorrelation analysis complete</p>
        </div>
        {savedUrl && (
          <a
            href={savedUrl}
...
function StatCard({ label, value, tone = "slate" }) {
  ...
  return (
    <div className={`rounded-xl bg-gradient-to-br ${tones[tone]} p-4`}>
